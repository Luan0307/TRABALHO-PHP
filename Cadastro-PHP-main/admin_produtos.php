...
<nav class="navbar navbar-dark bg-dark">
    <div class="container">
        <a href="dashboard.php" class="navbar-brand">Painel EcoArte</a>
...
<div class="container py-4">
    <div class="row g-4">
        <div class="col-lg-6">
            <div class="card shadow-sm">
                <div class="card-header bg-white">
                    <h1 class="h5 mb-0">Novo produto</h1>
                </div>
                <div class="card-body">
                    <?php if ($erro): ?>
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="nome" class="form-label">Nome da peca</label>
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                ...
                                <input type="number" id="preco" name="preco" class="form-control" step="0.01" min="0.01" value="<?= old('preco') ?>" required>
                            </div>
                            <div class="col-sm-6">
                                <label for="estoque" class="form-label">Estoque</label>
                                <input type="number" id="estoque" name="estoque" class="form-control" min="0" value="<?= old('estoque', '0') ?>" required>
                            </div>
                        </div>

                        <div class="mb-3 mt-3">
                            <label for="descricao" class="form-label">Descricao</label>
                            <textarea id="descricao" name="descricao" class="form-control" rows="4" required><?= old('descricao') ?></textarea>
                        </div>
        ...
        <div class="col-lg-6">
            <div class="card shadow-sm">
                <div class="card-header bg-white">
                    <h2 class="h5 mb-0">Ultimos produtos</h2>
                </div>
                        ...
                        <table class="table table-striped mb-0">
                            ...
                            <tbody>
                                ...
                                <?php if (empty($ultimosProdutos)): ?>
                                    <tr>
                                        <td colspan="5" class="text-center text-muted py-3">Nenhum produto cadastrado.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
